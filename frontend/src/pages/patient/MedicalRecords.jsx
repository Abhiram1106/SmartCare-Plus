...
const MedicalRecords = () => {
  ...
  const handleUpdateBasicInfo = async () => {
    try {
      await api.put(`/ehr/${user.id}/basic`, editData);
      showSuccess('Medical information updated successfully!');
      setEditMode(false);
      fetchMedicalRecord();
    } catch (error) {
      console.error('Error updating medical record:', error);
      showError('Failed to update medical information');
    }
  };
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-purple-500 hover:shadow-xl transition-all">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-600">{medicalRecord?.currentMedications?.length || 0}</p>
                <p className="text-xs text-gray-500 mt-1">
                  {medicalRecord?.currentMedications?.length > 0 ? 'Active' : 'None'}
                </p>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6 border-t-4 border-blue-500">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all shadow-md"
            >
              ...
              <div className="flex items-center space-x-4 p-5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-l-4 border-green-500 hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-800">
                    {medicalRecord?.height || 'N/A'} cm / {medicalRecord?.weight || 'N/A'} kg
                  </p>
                </div>
              </div>
                ...
                <div className="col-span-2 p-5 bg-yellow-50 rounded-xl border-l-4 border-yellow-500">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm text-yellow-800">
                      <span className="font-semibold">Emergency contact not set.</span> Click "Edit Info" to add emergency contact details.
                    </p>
                  </div>
                </div>
              )}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6 border-t-4 border-purple-500">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-semibold">
                {medicalRecord.currentMedications.length} active
              </span>
            </div>
         ...
         (!medicalRecord?.vitalSigns || medicalRecord.vitalSigns.length === 0) && (
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center border-2 border-dashed border-gray-300">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Start building your comprehensive health record by adding your medical information, allergies, medications, and more.
            </p>
            <button
              onClick={() => setEditMode(true)}
              className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all shadow-md font-semibold"
            >
