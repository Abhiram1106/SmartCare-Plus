    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">View and manage prescriptions you've created</p>
        </div>
        ...
        <div className="mb-6 bg-white rounded-xl shadow-lg p-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by diagnosis, patient name, or prescription number..."
                value={searchTerm}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{prescription.patient?.age || 'N/A'} years</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                {prescription.generalInstructions && (
                  <div className="mb-4 p-4 bg-green-50 rounded-xl border-l-4 border-green-500">
                    ...
                    <p className="text-green-800 text-sm">
                      {prescription.generalInstructions.length > 100 
                        ? `${prescription.generalInstructions.substring(0, 100)}...`
                        : prescription.generalInstructions
                      }
                    </p>
                  </div>
